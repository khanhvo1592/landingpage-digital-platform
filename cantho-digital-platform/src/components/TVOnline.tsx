...
export default function TVOnline() {
  ...
  const [isMuted, setIsMuted] = useState(true) // Bắt đầu với âm thanh tắt
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-2xl font-bold text-white mb-6">Kênh phát sóng</h3>
            ...
            {channels.map((channel) => (
              <motion.div
                ...
                className={`bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 cursor-pointer transition-all duration-300 border-2 ${
